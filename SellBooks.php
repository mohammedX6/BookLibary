...
echo "<div class='h1Header'><h2>Available Books</h2><br></div>";
...
$Result6=mysqli_query($conn,$query);
    ...
    echo"</table>";
   echo" <br><div class='h2Header'><h2>Please select a book from the table above by entering the book ID</h2><br></div>";
    ?>  
<div>
 <div class="form">
<div class='h1Header'><h2>Select one of the operations</h2><br></div>
<form class="Book-form" method="POST"  action="http://localhost/WepAppProject/SellBooksV2.php">
<input type="text" placeholder="Enter id" name="IDSell"/>
<input type="text" placeholder="Enter Your Number" name="NumberSell"/>
